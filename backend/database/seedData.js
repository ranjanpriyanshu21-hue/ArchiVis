...
export const ARCHITECTS = [
  {
    id: 1, name: "Jon Snow", title: "Principal Architect", firm: "Snow Design Studio",
    location: "Mumbai", experience: 18, rating: 4.9, reviews: 156, projects: 87,
    image: "https://commons.wikimedia.org/wiki/Special:Redirect/file/Kit_Harington_June_2014.jpg",
    specialties: ["Minimalist", "Industrial", "Adaptive Reuse"],
    bio: "Jon Snow trained at the AA London and returned to Mumbai with a singular obsession: honest materials. His 18-year practice has redefined luxury residential architecture in Maharashtra — stripping away ornament to reveal the beauty of structure.",
    awards: ["AIA Young Architect 2014", "Inside World Festival 2019", "Dezeen Award 2022"],
    startingBudget: "₹40 Lakh", phone: "+91 98765 43210", email: "jon@design.in",
    website: "snowdesign.in", instagram: "@jon.snow.arch", portfolioIds: [1, 6],
  },
  {
    id: 2, name: "Selena Gomez", title: "Creative Director", firm: "Studio SG",
    location: "Bangalore", experience: 12, rating: 4.8, reviews: 124, projects: 54,
    image: "https://upload.wikimedia.org/wikipedia/commons/f/fb/Selena_Gomez_at_the_2024_Toronto_International_Film_Festival_3_%28Cropped%29.jpg",
    specialties: ["Contemporary", "Minimalist", "Sustainable"],
    bio: "Selena is one of India's most sought-after residential architects under 40. Her work in Bangalore has established a vocabulary of quiet luxury that feels deeply local yet internationally relevant.",
    ...
    website: "studioSG.in", instagram: "@SG.architect", portfolioIds: [2, 10],
  },
  {
    id: 3, name: "Kunal Nair", title: "Founding Partner", firm: "Nair & Associates",
    location: "Delhi", experience: 22, rating: 4.7, reviews: 198, projects: 112,
    image: "https://commons.wikimedia.org/wiki/Special:Redirect/file/Kunal_Nayyar_by_Gage_Skidmore.jpg",
    specialties: ["Brutalist", "Biophilic", "Institutional"],
    bio: "Delhi-based Kunal Nair built his reputation on institutional commissions before turning to high-end residential. His Citadel Tower caused a national conversation about Brutalism's place in Indian cities.",
    ...
    website: "nairassociates.in", instagram: "@kunal.nair.arch", portfolioIds: [4, 11],
  },
  {
    id: 4, name: "Mary John", title: "Founder & Lead Designer", firm: "MJ Studio",
    ...
    bio: "A Harvard GSD graduate, MJ returned to design houses that breathe — biophilic, cross-ventilated, deeply conscious of the coastal landscape they inhabit.",
    awards: ["Architectural Digest Top 50 2022", "Wallpaper* Award 2023", "Green Building Award 2022"],
    startingBudget: "₹55 Lakh", phone: "+91 98765 43213", email: "MJ.studio",
    website: "MJ.studio", instagram: "@MJ.arch", portfolioIds: [3, 9],
  },
  {
    id: 5, name: "Elton John", title: "Senior Architect", firm: "John Heritage Studio",
    location: "Pune", experience: 15, rating: 4.6, reviews: 143, projects: 68,
    image: "https://commons.wikimedia.org/wiki/Special:Redirect/file/Elton_John_2022.jpg",
    specialties: ["Art Deco", "Heritage", "Luxury"],
    bio: "Elton is the architect collectors call when they want history treated with reverence. His Art Deco Manor in Koregaon Park has become one of Pune's most photographed private houses.",
    awards: ["UNESCO Asia-Pacific Heritage Award 2020", "INTACH Award 2019", "Condé Nast India Award 2022"],
    startingBudget: "₹60 Lakh", phone: "+91 98765 43214", email: "elton@johnheritagestudio.in",
    website: "johnheritagestudio.in", instagram: "@elton.john.arch", portfolioIds: [5],
  },
  {
    id: 6, name: "Sheldon Agarwal", title: "Design Principal", firm: "Agarwal Futura",
    ...
    bio: "A computational design specialist trained at TU Delft, Sheldon uses parametric tools to generate organic forms impossible to achieve by hand — then executes them with surgical precision.",
    awards: ["Fast Company Innovation Award 2023", "A+Awards Residential 2022", "CII Smart Home Award 2023"],
    startingBudget: "₹1 Crore", phone: "+91 98765 43215", email: "sheldon@agarwalfutura.in",
    website: "agarwalfutura.in", instagram: "@sheldon.agarwal.arch", portfolioIds: [7],
  },
  {
    id: 7, name: "Dev Cooper", title: "Conservation Architect", firm: "Cooper Conservation",
    ...
    bio: "Dev Cooper is India's foremost colonial conservation architect. His methodology — document everything, disturb nothing, restore only what you understand — has saved dozens of Tamil Nadu's heritage buildings.",
    awards: ["INTACH Conservation Award 2015 & 2019", "Government of India Heritage Award 2021", "AIA International Award 2022"],
    startingBudget: "₹50 Lakh", phone: "+91 98765 43216", email: "dev@cooperconservation.in",
    website: "cooperconservation.in", instagram: "@dev.cooper.arch", portfolioIds: [8],
  },
  {
    id: 8, name: "Martha Stewart", title: "Architect & Urban Designer", firm: "Stewart Urban Studio",
    location: "Kolkata", experience: 7, rating: 4.5, reviews: 68, projects: 22,
    image: "https://commons.wikimedia.org/wiki/Special:Redirect/file/Martha_Stewart_by_Gage_Skidmore.jpg",
    specialties: ["Industrial", "Adaptive Reuse", "Urban"],
    bio: "MArtha Stewart has made adaptive reuse her mission — transforming Kolkata's crumbling industrial heritage into desirable contemporary living. Steel Canvas is the city's most talked-about residential renovation in a decade.",
    awards: ["Young Gun Award 2022", "Urban Design Award Kolkata 2023", "Housing India Award 2023"],
    startingBudget: "₹35 Lakh", phone: "+91 98765 43217", email: "martha@stewartstudio.in",
    website: "Stewarturbanstudio.in", instagram: "@Stewart.arch", portfolioIds: [12],
  },
];
